...
.DESCRIPTION
    ...
    consumer yet still applies their settings; the PSScriptAnalyzer component owns the rules, this only
    invokes them. It is a minimal, component-owned runner with no dependency on the ci-workflows pwsh
