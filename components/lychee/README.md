...
siblings and stale pre-transfer owner URLs remain checked. It also excludes a
small explicit set of public hosts that reject automated link checkers while
remaining browser-accessible. Lychee documents `exclude` values as URL regular
expressions in its [configuration guide][1].
