...
- **Application services orchestrate; command handlers do one operation.** Multi-step work that spans aggregates, such as a batch import or a cross-aggregate workflow, belongs in an application service that injects domain services and repositories directly.
