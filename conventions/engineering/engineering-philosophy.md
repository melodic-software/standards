...
- **Timeout-first / resilient by default.** Every outbound call carries a timeout from its first implementation. Add retry with backoff and circuit breakers where a dependency can be slow or flaky.
