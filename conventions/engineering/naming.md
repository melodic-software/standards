...
- Martin, *Clean Code* (Prentice Hall, 2008), Ch. 2 "Meaningful Names", on noise words adding no meaning: [book page](https://www.informit.com/store/clean-code-a-handbook-of-agile-software-craftsmanship-9780132350884)
...
- Yegge, "Execution in the Kingdom of Nouns" (2006), on the Noun-Verber anti-pattern: [post](http://steve-yegge.blogspot.com/2006/03/execution-in-kingdom-of-nouns.html)
- Fowler & Beck, *Refactoring*, on the Large Class / God Class smell: [refactoring.guru](https://refactoring.guru/smells/large-class)
