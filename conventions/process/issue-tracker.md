...
Every new issue passes through triage. The floor label is the bare marker `needs-triage`, a deliberate exception to the colon-space grammar (see "Naming grammar" above). It carries the not-yet-classified state. Priority labels are assigned priorities only.
