...
- **About 45% of AI-generated samples failed security tests**, each introducing a common vulnerability class, across 100+ models and four languages (Veracode, July 2025). Security performance did not improve with model size. That is a structural limitation, not one a larger model resolves.
