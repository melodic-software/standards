...
- **Incumbency as the only justification** — a boundary or design decision defended purely descriptively, with no normative argument; see `../engineering/engineering-philosophy.md`.
