...
Every external integration, whether a package, a CI action, a plugin, a tool server, a browser extension, or a reusable workflow, is vetted before adoption and monitored after:
