...
### Phase 6.3: reusable prep (ci-workflows PR + release) [PENDING]
...
### Phase 6.4: cutover + Bash retirement + control inversion (standards PR series) [PENDING]
